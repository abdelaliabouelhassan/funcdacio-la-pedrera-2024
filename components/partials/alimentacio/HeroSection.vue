<template>
    <section class="h-screen max-h-[46.94rem] relative flex justify-center items-center">
        <img v-if="width <= 768" class="z-0 absolute top-0 left-0 h-full w-full object-cover object-center md:hidden" src="/images/alimentacio/hero1.svg" alt="hero" srcset="">
        <img v-else class="hidden z-0 absolute top-0 left-0 h-full w-full object-cover object-left-top md:block" src="/images/alimentacio/hero.png" alt="hero" srcset="">
