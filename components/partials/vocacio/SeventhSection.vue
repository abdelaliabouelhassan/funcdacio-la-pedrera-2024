    ...
    <div class="w-full py-16 sm:px-8 md:px-4 lg:px-12">
      ...
      >
        <div class="w-full md:max-w-[27.5rem] space-y-10 px-4 sm:px-0">
          <div class="w-full space-y-8 border-t border-black">
            ...
            <p class="text-black text-lg font-normal font-super-rotesk-comp">
              ...
              l’alumnat. <br />
              <br />
              Es van establir les línies estratègiques per desplegar, a partir
              del proper curs, una
              ...
              Sant Benet la cloenda del projecte dels hàbits saludables en el
              món digital i de l’alimentació, conjuntament amb alumnes i
              ...
              pràctiques dels últims cursos de grau i postgrau. <br />
              <br />
              El
              <span class="font-bold"
                >projecte singular per alumnat d’esport d’alt rendiment</span
              >, va continuar després de 3 anys oferint acompanyament a joves
              atletes nacionals i internacionals que arriben a la ciutat en
              edats de primària i ESO, les seves famílies, i entitats esportives
        ...
        <div class="w-full md:max-w-[37.5rem] h-[40rem] overflow-hidden">
          <img
            src="/images/vocacio/article-img-11.svg"
