            ...
            <div class="w-full max-w-[27.5rem] space-y-10">
                ...
                <div class=" w-full  space-y-8 border-t border-black px-4 xl:px-0">
                    ...
                    <p class="  text-black text-lg font-normal font-super-grotesk-ot ">
                        ...
                        <br><br>També es dona suport a la recerca puntera amb la Càtedra Fundació Catalunya La Pedrera · Ignacio Cirac, amb l’Institut de Ciències Fotòniques (ICFO), i es potencia l’excel·lència científica col·laborant amb el Barcelona Institut of Science and Technology (BIST).
                        <br><br>La Fundació Catalunya La Pedrera promou, conjuntament amb el diari La Vanguardia, el Premi Vanguardia de la Ciència amb l’objectiu de fomentar l’excel·lència en l’àmbit de la recerca. En l’edició de 2022 es va acordar donar més visibilitat als projectes liderats per dones, amb la voluntat de reconèixer la seva feina, posar-la en valor i posicionar-les com a models de referència per a futures generacions de nenes i joves amb vocació científica. La guanyadora d’aquesta any ha estat la Dra. Enriqueta Felip, cap de secció del servei d’Oncologia del Vall d’Hebron Institut d’Oncologia (VHIO), per una recerca sobre la immunoteràpia en el càncer de pulmó
                    </p>
                </div>
            </div>
