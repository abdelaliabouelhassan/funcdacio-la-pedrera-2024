    ...
    <div class="w-full py-16 px-4 sm:px-8 md:px-4 lg:px-12">
      ...
      >
        <div class="flex flex-col text-center space-y-2 w-[16.5rem]">
          <span
            class="text-Olive-Green font-bold lg:font-medium leading-[3.75rem] sm:font-super-grotesk-web text-[4rem] sm:text-[5rem] lg:text-[7rem]"
            ><Number :number="485.043"
          /></span>
          <span
            class="text-Olive-Green font-medium leading-[2.5rem] font-super-rotesk-comp text-center pl-0 sm:pl-6 lg:pl-16 lg:pt-8 text-[4rem]"
            >persones</span
          >
        </div>
        <div class="md:max-w-[26.625rem] w-full">
          <p class="text-lg font-bold text-black font-super-rotesk-comp">
            Cal trobar solucions innovadores i accions que contribueixin a
            revertir l’actual situació d’emergència climàtica. La Fundació
            Catalunya La Pedrera disposa d’un capital natural que permeten posar
            en pràctica solucions diverses a través de la gestió forestal, les
            energies renovables, la conservació de la biodiversitat i
      ...
      >
        <div class="w-full md:max-w-[27.5rem] space-y-10 px-4 sm:px-0">
          <div class="w-full space-y-8 border-t border-black">
            ...
            >
              APOSTA PER LA SOSTENIBILITAT ENERGÈTICA
            </h1>
            <p class="text-black text-lg font-normal font-super-grotesk-ot">
              Amb la voluntat de caminar cap a la sostenibilitat, la Fundació ha
          ...
          <div class="w-full space-y-8 border-t border-black pt-4">
            ...
            <p class="text-black text-lg font-normal font-super-grotesk-ot">
              La Fundació aposta per la gestió forestal com a eina per
              ...
              Urgell i el Sobrarbe a l’Aragó, desenvolupant alhora dinàmiques de
              reactivació del sector forestal a través de la formació i
              capacitació tècnica i de models de bioeconomia basats en
              l’aprofitament de la biomassa i de la fusta per a la
              bioconstrucció. <br />
              <br />
        ...
        <div class="w-full md:max-w-[37.5rem] h-[40rem] overflow-hidden">
          <img
            src="/images/territori/Fundació.svg"
