<template>
    <div>
        ...
        <div  class="relative overflow-hidden">
            <FirstSection />
            <img class="z-10 hidden md:block mix-blend-multiply opacity-70 absolute top-48 left-[86%] xl:left-auto xl:right-0" 
                src="/images/territori/bg-vector-1.svg" alt="">
        </div>
        <div class="relative">
            <SecondSection />
            <img class="z-10 hidden md:block mix-blend-multiply opacity-70 absolute -top-32 right-[84%] xl:right-auto xl:-left-3" 
                src="/images/territori/bg-vector-2.svg" alt="">
        </div>
    </div>
</template>
<script setup>
